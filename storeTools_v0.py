...
#def getEOSlslist(directory, mask='', prepend='root://eosuser//eos/user'):
    from subprocess import Popen, PIPE
    print 'looking into: '+directory+'...'

    fullPaths=['/eos/cms/'+directory]
    #fullPaths=['/eos/user/k/kjaffel/'+directory]
    ...
    for fullPath in fullPaths:
        ...
        for item in items:
            ...
            #full_list.append(prepend + fullPath.split("/eos/user/k/kjaffel")[-1] + '/' + item)
