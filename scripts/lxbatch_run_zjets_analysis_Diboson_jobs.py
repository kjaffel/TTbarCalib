...
cd $WORKING_DIR
echo $WORKING_DIR
python runZJetsAnalysis.py -i /store/group/phys_btag/Commissioning/ZJets/KINMistag-2018-06-09_StructuredDir/ -o ${WORKING_DIR}/output_ntuples_2018-08-09/ -j ${WORKING_DIR}/data/samples_Run2018_Mistag_Diboson.json
